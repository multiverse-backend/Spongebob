defmodule SpongebobApiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpongebobApiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpongebobApiWeb.Gettext, "errors", msg, opts)
    end
  end
